	...
	<div class="index">
		<div class="login">
			<form action="MyFormController" method="post">
				Username: <br></br>
				<input required class="input" type="text" name="username"></input>
				<br></br>
				Password: <br></br>
				<input required class="input" type="password" name="password"></input>
				<br></br>
				Repeat Password: <br></br>
				<input required class="input" type="password" name="repeatPassword"></input>
				<br></br><br></br>
